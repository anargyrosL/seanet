...
private[spark] abstract class Task[T](
  ...
  final def run(
      ...
      isSeanet: Boolean = false): T = {
    if (!isSeanet) {
      SparkEnv.get.blockManager.registerTask(taskAttemptId)
    }
    System.out.println("seanet inside run stage id: " + stageId + " paritionid " + partitionId)
    ...
    val taskContext = new TaskContextImpl(
      ...
      resources,
      isSeanet)
    System.out.println("seanet context created")
    if (!isSeanet) {
    ...
    System.out.println("seanet CallerContext created")
    ...
    try {
      ...
      case e: Throwable =>
        ...
        System.out.println("seanet exception in task run " + e.getMessage)
        try {
